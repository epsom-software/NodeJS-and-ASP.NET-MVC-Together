...
interface JQueryStatic {
    ...
    *****/
    ...
    //grep<T>(array: T[], func: (elementOfArray: T, indexInArray: number) => bool, invert?: bool): T[];
    ...
    * @param keepScripts A bool indicating whether to include scripts passed in the HTML string
    */
